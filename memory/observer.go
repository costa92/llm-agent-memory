...
// (reuse the Working.Add embedding inside the native WorkingMemory's
// evictIfOverCapacity rather than re-embedding the probe) is tracked as
// deferred.
//
...
// test TestObserver_B2_WorkingEvictionStillPicksLowestScoredItem so a
// future optimization cannot cause a silent regression.
